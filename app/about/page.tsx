...
const about = () => {
    return (
        <div className="mt-20 min-h-screen px-8 md:px-20 lg:px-[15rem]">
            ...
            <div className="text-2xl font-bold pt-6">Vision</div>
            ...
            <ul className="text-justify pt-2 list-disc pl-4">
                ...
                <li>
                    Contributing for creation of healthy, vibrant and
                    sustainable society by involving in Institutional Social
                    Responsibility (ISR) activities like rural development,
                    welfare of senior citizens, women empowerment, community
            ...
            <ul className="text-justify pt-2 list-disc pl-4">
                ...
                <li>
                    To catalyse and promote development of student
                    knowledge-based enterprises and promote employment
                    opportunities in the innovative areas.
                </li>
            </ul>
        </div>
    );
