...
export default function Home() {
	return (
		<>
			...
			<Marquee />
			<div className="flex flex-col md:flex-row justify-center items-center p-2 mb-4 gap-4">
				<Image
					src="https://i.ibb.co/12pxVBT/IMG-20230214-WA0076.jpg"
					width={500}
					height={300}
					alt="IPL poster"
					className="max-w-[300px] md:max-w-[500px] lg:max-w-full object-cover"
				/>
				<Image
					src="https://i.ibb.co/smMvGWT/Whats-App-Image-2024-03-19-at-8-48-18-AM.jpg"
					width={500}
					height={300}
					alt="IPL poster"
					className="max-w-[300px] md:max-w-[500px] lg:max-w-full object-cover"
