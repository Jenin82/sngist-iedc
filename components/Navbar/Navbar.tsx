		...
		<div className="navbar bg-base-100 fixed top-0 z-50 shadow">
			...
			<div className="navbar-end">
				...
				<div className="hidden lg:flex md:hidden">
					<button className="btn btn-ghost btn-circle">
						<Link
							href="https://www.instagram.com/iedc_sngist/"
							target="_blank"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
					...
					<button className="btn btn-ghost btn-circle">
						<Link
							href="https://www.facebook.com/iedcsngist?mibextid=ZbWKwL"
							target="_blank"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
					...
					<button className="btn btn-ghost btn-circle">
						<Link
							href="https://www.youtube.com/@iedcsngist"
							target="_blank"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
				...
				<button className="flex items-center md:mr-4 ml-1">
					<Link
						className="bg-accent text-accent-content px-3 py-2 rounded-lg hover:bg-accent-content hover:text-accent"
						href={"https://forms.gle/jtkQ6END2AsnaBZH7"}
						target="_blank"
							...
							<ul className="menu p-4 w-60 min-h-full bg-base-200 text-base-content font-bold">
								...
								<div className="flex flex-col justify-center items-center">
									...
									<li className="flex flex-row">
										<Link
											href="https://www.instagram.com/sngist_iedc"
											target="_blank"
										>
											<svg
												xmlns="http://www.w3.org/2000/svg"
