    ...
    return (
      <div className="navbar bg-base-100 fixed top-0 z-50 shadow">
        ...
        <div className="navbar-end">
          ...
          <div className="hidden md:flex">
          <Link href="https://www.instagram.com/sngist_iedc" target="_blank" className="hover:bg-gray-200">
            <Image
              src="/insta.svg"
              width={27}
              height={27}
          ...
          <Link href="https://www.facebook.com/iedcsngist?mibextid=ZbWKwL" target="_blank" className="hover:bg-gray-200 ">
            <Image
                src="/facebook.svg"
                width={27}
                height={27}
          ...
          <Link href="https://www.youtube.com/@iedcsngist" target="_blank" className="hover:bg-gray-200">
            <Image
                src="/youtube.svg"
                width={27}
                height={27}
